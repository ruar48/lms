            ...
            <div class="span9" id="content">
                <div class="row-fluid">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li><a href="#"><b>School Year:
                                    <?php echo $school_year_query_row['school_year']; ?></b></a><span
                    ...
                    if ($read_row !== null) {
                        // Check if the 'student_read' index exists in the $read_row array
                        if (isset($read_row['student_read'])) {
                            $yes = $read_row['student_read'];
                        } else {
                            // Handle the case where 'student_read' index is not set (optional)
                            $yes = null; // or any other default value you want to assign
                        }
                    } else {
                        // Handle the case where $read_row is null (optional)
                        $yes = null; // or any other default value you want to assign
                    }
					...
					?>
                                    <div class="post" id="del<?php echo $id; ?>">
                                        ...
                                        <a
                                            href="<?php echo $row['link']; ?><?php echo '?id='.$get_id; ?>&<?php echo 'post_id='.$assignment_id; ?>">
                                        ...
                                        <div class="pull-right">
                                            <i
                                                class="icon-calendar"></i>&nbsp;<?php echo $row['date_of_notification']; ?>
                                        </div>
