        ...
        <div class="row-fluid">
            ...
            <div class="span9" id="content">
                <div class="row-fluid">
					...
					?>
                    <ul class="breadcrumb">
                        <li><a href="#"><b><?php echo $row['class_name']; ?></b></a> <span class="divider">/</span></li>
                        <li><a href="#"><b><?php echo $row['subject_code']; ?></b></a> <span class="divider">/</span>
                        </li>
                        <li><a href="#"><b>School Year: <?php echo $row['school_year']; ?></b></a> <span
