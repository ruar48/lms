                            ...
                            <div class="span12">
                                ...
                                <form action="delete_shared.php" method="post">
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="">
                                        <a data-toggle="modal" href="#backup_delete" id="delete" class="btn btn-success"
                                            name=""><i class="icon-move icon-large"></i> Move</a>
									...
									?>
                                            <tr id="del<?php echo $id; ?>">
                                                ...
                                                <td width="30"><a href="<?php echo $row['floc']; ?>"><i
