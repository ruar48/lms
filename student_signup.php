...
// $query = mysqli_prepare($conn, "SELECT * FROM student WHERE username='$username' AND firstname='$firstname' AND lastname='$lastname' AND class_id='$class_id'") or die(mysqli_error($conn));
