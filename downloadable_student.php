                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                ...
                                <?php
									...
									$count = mysqli_num_rows($query);	
								if ($count == '0'){ ?>
                                <div class="alert alert-info"><i class="icon-info-sign"></i> No downloadable material
                                    currently uploaded.</div>
                                <?php
								}else{
								?>
                                ...
                                <form action="copy_file_student.php" method="post">
                                    ...
                                    <a data-toggle="modal" href="#user_delete" id="delete" class="btn btn-info"
                                        name=""><i class="icon-copy"></i> Copy Check item to backpack</a>
