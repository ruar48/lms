                        ...
                        <div class="block-content collapse in">
                            <div id="downloadable_table.php" class="span12">
                                ...
                                <?php
										...
										if ($count == '0'){ ?>
                                <div class="alert alert-info"><i class="icon-info-sign"></i> Currently you did not
                                    upload any downloadable materials</div>
                                ...
                                <form action="copy_file.php" method="post">
                                    ...
                                    <a data-toggle="modal" href="#user_delete" id="delete" class="btn btn-info"
                                        name=""><i class="icon-file"></i> Copy Check item</a>
