                        ...
                        <div class="block-content collapse in">
                            <div class="span12">
                                <div class="pull-right">
                                    <a href="add_quiz.php" class="btn btn-info"><i class="icon-plus-sign"></i> Add
                                        Quiz</a>
                                    <td width="30"><a href="add_quiz_to_class.php" class="btn btn-success"><i
                                                class="icon-plus-sign"></i> Add Quiz to Class</a></td>
                                </div>
                                ...
                                <form action="delete_quiz.php" method="post">
									...
									?>
                                            <tr id="del<?php echo $id; ?>">
                                                ...
                                                <td><a href="quiz_question.php<?php echo '?id='.$id; ?>">Questions</a>
                                                </td>
