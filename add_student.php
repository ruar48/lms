            ...
            <div class="span9" id="content">
                <div class="row-fluid">
                    ...
                    <div class="pull-right">
                        <a href="my_students.php<?php echo '?id='.$get_id; ?>" class="btn btn-info"><i
                            ...
                            <div class="span12">
                                <form method="post" action="">
                                    ...
                                    <button name="submit" type="submit" class="btn btn-info"><i
                                            class="icon-save"></i>&nbsp;Add Student</button>
                                    <br>
                                    <br>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                        ...
                                        ?>
                                            ...
                                            <tr>
                                                ...
                                                <td width="70"><img class="img-rounded"
                                                        src="admin/<?php echo $row['location']; ?>" height="50"
                                                        width="40"></td>
                                                ...
                                                <td width="80">
                                                    ...
                                                    <input type="hidden" name="student_id<?php echo $a; ?>"
                                                        value="<?php echo $id; ?>">
